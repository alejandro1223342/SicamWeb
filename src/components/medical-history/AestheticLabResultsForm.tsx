...
export default function AestheticLabResultsForm({ patientId, recordId, sessionId, data, onChange, onUploadingChange, readOnly = false }: AestheticLabResultsFormProps) {
    ...
    const handleAddItem = () => {
        ...
        setShowModal(false);
        toast.success('Resultado de laboratorio (Estética) agregado correctamente.');
    };
    ...
    const handleRemove = async (id: string) => {
        ...
        toast.success('Resultado de laboratorio (Estética) eliminado correctamente.');
    };
    ...
    const handleFileSelection = async (fileList: FileList) => {
        ...
        for (const file of files) {
            ...
            try {
                // Folder: Examenes de Estética, Specialty: Estetica
