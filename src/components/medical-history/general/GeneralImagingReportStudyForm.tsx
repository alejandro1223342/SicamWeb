...
interface GeneralImagingReportStudyFormProps {
    data: StudyData;
    onChange: (data: StudyData) => void;
    readOnly?: boolean;
}

const GeneralImagingReportStudyForm: React.FC<GeneralImagingReportStudyFormProps> = ({ data, onChange, readOnly }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div>
                ...
                <textarea 
                    placeholder="Describa el estudio de imagenología efectivamente realizado..." 
...
export default GeneralImagingReportStudyForm;
