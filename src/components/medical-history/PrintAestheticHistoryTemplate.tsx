...
interface PrintAestheticHistoryTemplateProps {
    patient: any;
    data: any; // This will contain the full record data
}

const PrintAestheticHistoryTemplate: React.FC<PrintAestheticHistoryTemplateProps> = ({ patient, data }) => {
    ...
    return (
        <div className="print-medical-history" style={{ 
            ...
            <h1 style={{ textAlign: 'center', fontSize: '16px', fontWeight: '900', margin: '0 0 10px 0' }}>HISTORIA CLÍNICA ESTÉTICA</h1>
...
export default PrintAestheticHistoryTemplate;
